...
export function buildColossusVoxels(type) {
  switch (type) {
    case 'sentinel': return buildSentinelVoxels();
    case 'wraith': return buildWraithVoxels();
    case 'titan': return buildTitanVoxels();
    default: throw new Error(`unknown colossus type: ${type}`);
  }
}
