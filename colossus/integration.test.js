...
const mockTHREE = {
  Group: class {
    constructor() { this.children = []; this.position = { x: 0, y: 0, z: 0, set() {} }; this.rotation = { x: 0, y: 0, z: 0, set() {} }; }
    add(child) { this.children.push(child); }
  },
  Mesh: class {
    constructor() { this.position = { x: 0, y: 0, z: 0, set() {} }; this.rotation = { x: 0, y: 0, z: 0, set() {} }; this.scale = { x: 1, y: 1, z: 1, set() {} }; this.castShadow = false; this.receiveShadow = false; this.userData = {}; this.material = { emissiveIntensity: 0.5 }; this.add = () => {}; }
  },
  ...
  BufferGeometry: class { constructor() { this.attributes = {}; this.index = null; } setAttribute() {} setIndex() {} computeVertexNormals() {} },
