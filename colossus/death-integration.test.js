...
describe('applyDeathToMesh', () => {
  it('applies transform to each mesh in meshByPart', () => {
    ...
    const mesh1 = { position: { x: 0, y: 5, z: 0 }, rotation: { x: 0, y: 0, z: 0 }, material: { opacity: 1 } };
    const mesh2 = { position: { x: 10, y: 3, z: 0 }, rotation: { x: 0, y: 0, z: 0 }, material: { opacity: 1 } };
  ...
  it('sets transparent and opacity during dissolve', () => {
    ...
    const mesh = { position: { x: 0, y: 5, z: 0 }, rotation: { x: 0, y: 0, z: 0 }, material: { opacity: 1 } };
  ...
  it('does not set transparent when no dissolve', () => {
    ...
    const mesh = { position: { x: 0, y: 5, z: 0 }, rotation: { x: 0, y: 0, z: 0 }, material: { opacity: 1, transparent: false } };
    const meshByPart = new Map([['torso', mesh]]);
    const meshGroup = { meshByPart };
  ...
  it('applies rotation changes from death transform', () => {
    ...
    const mesh = { position: { x: 0, y: 12, z: 0 }, rotation: { x: 0, y: 0, z: 0 }, material: { opacity: 1 } };
