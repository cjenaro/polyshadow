...
import { BlockType, isBlockSolid, isBlockTransparent, getBlockColor, getBlockEmissive, BLOCK_PROPERTIES } from '../world/block-types.js';
...
describe('block-types', () => {
  ...
  it('RUNE_GLOW has emissive color', () => {
    ...
    assert.ok(emissive[0] > 0 || emissive[1] > 0 || emissive[2] > 0, 'rune glow should have emissive');
  });
